...
Voronoi.prototype.InsertParabola = function(p){
    ...
    var edge_l = new vEdge(start, par.site, p);
    var edge_r = new vEdge(start, p, par.site);
...
Voronoi.prototype.RemoveParabola = function(e){
    ...
    if(pl.parent.left == p1){
        ...
        else gparent.rihgt = pl.parent.left;
    }
